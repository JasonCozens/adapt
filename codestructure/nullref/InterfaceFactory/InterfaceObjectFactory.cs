...
namespace InterfaceFactory
{
    ...
    public static class InterfaceObjectFactory
    {
        ...
        static InterfaceObjectFactory()
        {
            ...
            //AssemblyBuilder C = appDomain.DefineDynamicAssembly(
            ...
            ModuleBuilder = assemblyBuilder.DefineDynamicModule("InterfaceObjectFactoryModule.InterfaceObjectFactory.dll");
        }
